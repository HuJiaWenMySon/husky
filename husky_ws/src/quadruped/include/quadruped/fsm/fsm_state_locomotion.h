#ifndef QUADRUPED_FSM_FSM_STATE_LOCOMOTION_H_
#define QUADRUPED_FSM_FSM_STATE_LOCOMOTION_H_
...
class FsmStateLocomotion: public FsmState
{
public:
    FsmStateLocomotion(ControlFsmData* data);
    ~FsmStateLocomotion();
    virtual void Enter();
    virtual void Run();
    virtual void Exit();
...
private:
    ...
    Vec3 base_velocity_desired_in_world_frame_;                 //世界坐标系下期望的及做速度
...
#endif//QUADRUPED_FSM_FSM_STATE_LOCOMOTION_H_